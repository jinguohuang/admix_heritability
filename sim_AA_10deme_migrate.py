#run this followed by seed and migration rate, e.g python AA_10deme_mig_sim.py 0.05 1, note this mig_rate is one-directional
#simulate AA 10 demes model with different migration rate
import msprime, sys
from math import log
from math import exp
mdeme=float(sys.argv[1]) # migration rate between neighboring demes, one direction
seed = int(sys.argv[2]) # input the seed
#seed = 1
...
filename=f'AA_10Mb_10deme_{str(mdeme)}_chr{seed}.vcf'
