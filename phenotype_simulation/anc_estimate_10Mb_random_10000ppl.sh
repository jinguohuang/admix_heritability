...
do
	...
	python sim_AA_random_mate_10000ppl.py ${chr}
	echo "Processing chr${chr}"
	name=AA_10Mb_random_10000ppl_chr${chr}
...
name=AA_10Mb_random_10000ppl_chr1_10
echo "The name is ${name}"

echo "merging vcf files"
bcftools concat AA_10Mb_random_10000ppl_chr*_AT.vcf.gz \
-o ${name}_AT.vcf.gz \
-O z
