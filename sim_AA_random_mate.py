...
# Admixture event, 0.76525 Africa, rest Europe
admixture_event = [
    msprime.MigrationRateChange(time=Tadmix, rate=0.0), #newly added, change the migration rate to 0
    msprime.MassMigration(time=Tadmix, source=2, destination=0, proportion=0.76525), # African came to America        
...
filename=f'AA_10Mb_random_chr{seed}.vcf'
