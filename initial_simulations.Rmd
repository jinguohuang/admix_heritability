...
f1 = 0.8 #frequency in pop1
f2 = 0.3 # frequency in pop2
fbar = (f1 + f2)/2
theta = 0.5 #admixture fraction
nloci = 200 #number of loci
vg = 0.8 #desired total genetic variance
...
#choose effect sizes for 200 loci
bg = matrix(
...
lanc = replicate(nloci, rbinom(10000, 2, fbar))
