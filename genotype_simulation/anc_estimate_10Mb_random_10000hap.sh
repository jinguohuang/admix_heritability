...
##To use this script, one need to put migrate when run. e.g ./anc_estimate_10Mb_migrate.sh

for chr in {1..10}
do
	echo "Generating vcf for chr${chr}"
	python sim_AA_random_mate_10000hap.py ${chr}
	echo "Processing chr${chr}"
	name=AA_10Mb_random_10000hap_chr${chr}
...
name=AA_10Mb_random_10000hap_chr1_10
echo "The name is ${name}"

echo "merging vcf files"
bcftools concat AA_10Mb_random_10000hap_chr*_AT.vcf.gz \
-o ${name}_AT.vcf.gz \
-O z
