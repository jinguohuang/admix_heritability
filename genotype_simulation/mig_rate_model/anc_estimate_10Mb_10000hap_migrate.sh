...
##To use this script, one need to put filename and migrate rate when run. e.g ./anc_estimate_10Mb_10000hap_migrate.sh sim_AA_10deme_10000hap.py 0.025
...
do
	...
	python ${pyfile} ${mig_rate} ${chr}
	echo "Processing chr${chr} mig rate ${mig_rate}"
	name=AA_10Mb_10deme_10000hap_mig${mig_rate}_chr${chr}
...
name=AA_10Mb_10deme_10000hap_mig${mig_rate}_chr1_10
echo "The name is ${name}"

echo "merging vcf files"
bcftools concat AA_10Mb_10deme_10000hap_mig${mig_rate}_chr*_AT.vcf.gz \
-o ${name}_AT.vcf.gz \
-O z
