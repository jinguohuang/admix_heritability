#run this followed by migration rate, e.g python AA_10deme_mig_sim.py 0.05, note this mig_rate is one-directional
...
filename=f'AA_10Mb_10deme_hap_{str(mdeme)}.vcf'
