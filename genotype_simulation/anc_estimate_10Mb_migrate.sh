...
do
	...
	python sim_AA_10deme_migrate.py ${mig_rate} ${chr}
	echo "Processing chr${chr} mig rate${mig_rate}"
	name=AA_10Mb_10deme_${mig_rate}_chr${chr}
...
name=AA_10Mb_10deme_${mig_rate}_chr1_10
echo "The name is ${name}"

echo "merging vcf files"
bcftools concat AA_10Mb_10deme_${mig_rate}_chr*_AT.vcf.gz \
-o ${name}_AT.vcf.gz \
-O z
