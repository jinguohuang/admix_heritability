...
## changed the initial pop size for random to 1k, 10deme to 100/deme
...
parser.add_argument("--nadmix",dest="nadmix",help="initial size of admixed population",type=int,default=1000,nargs="?")
