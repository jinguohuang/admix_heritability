...
png("skt_test_dist_sim_asw.png", width=4, height=4, units="in", res=300)
hist(deme10_test, col='blue', xlim=c(0, 1), main = "Distribution of SKT test results", xlab="Spearman correlation")
hist(random_test, col='red', add=T)
#hist(ASW_test, col='green', add=T)
dev.off()
