...
# output the file for plink score, col1 ID, col2 Ref, col3 beta
beta = rnorm(1000, mean = 0, sd = sqrt(0.8))
causal.variants$beta=beta
score=causal.variants[,c("ID","REF", "beta")]
# output the file
write.table(score, file = "CausalVariantScore.txt", quote=F, row.names = F, col.names = F)
